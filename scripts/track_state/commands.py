...
COMMAND_GROUPS = [
    ...
    ("Naming", ["derive-name", "propose-shape", "propose-grounding",
                "resolve-track", "check"]),
    ("New-Track Resume", ["new-track-resume", "new-track-init", "new-track-step",
                          "new-track-set-mode", "new-track-set-shape",
                          "new-track-finalize"]),
    ("Brief", ["brief-resume", "pending-briefs", "brief-init",
               "brief-finalize", "brief-grill-done"]),
    ("Diagnostics", ["validate", "gc", "shas", "post-loop-status", "checklist-verify",
                     "deferred-report", "phase-done", "add-checkpoint", "replan",
                     "preflight", "quality-snapshot", "spec-integrity", "spec-anchors",
                     "spec-delta", "task-context", "view", "status"]),
