...
|                 | Doc Conventions         | *(plugin-provided)*                    | Authoring rules live in the Conductor plugin's `doc-conventions.md` (loaded on demand by doc-syncer/doc-linter/wiki) — not a project file; do not hand-create.                              |
